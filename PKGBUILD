...
package() {
	...
	cp "${pkgdir}/rofi-shortcuts.conf" "~/.config/rofi/rofi-shortcuts/rofi-shortcuts.conf"
	cp "${pkgdir}/rofi-shortcut.sh" "~/.local/share/rofi/rofi-shortcuts/rofi-shortcuts.sh"
